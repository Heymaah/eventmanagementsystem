...
<body id="page-top">
  ...
  <nav class="navbar navbar-b navbar-trans navbar-expand-md fixed-top" id="mainNav">
    <div class="container">
      ...
      <div class="navbar-collapse collapse justify-content-end" id="navbarDefault">
        <ul class="navbar-nav">
          <li class="nav-item">
            <a class="nav-link js-scroll" href="dasboard.php">Dashboard</a>
          </li>
        </ul>
      </div>
    </div>
  ...
  <!--/ Intro Skew Star /-->
  <div id="home" class="intro route bg-image" style="background-image: url(img/BG2.jpg)">
                   ...
                   <h4 class="form-input form-control">Select Service  : <select class="form-input" id="select" >
                    <option value="vid">Venue</option>
                      <option value="cid">Catering</option>
                        <option value="pid">Media</option>
                        <option value="did">Decoration</option>
                        <option value="mkid">Makeup Artist</option>
                          <option value="tid">Trousseau</option>
                          <option value="mid">Entertainment</option>
                            <option value="ctid">Costume</option>
                            <option value="ckid">Cakes</option>
